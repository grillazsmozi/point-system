...
exports.EntryUpdateFailed = exports.EntryNotFound = exports.Entry = exports.BaseEntry = void 0;
class BaseEntry {
...
class EntryUpdateFailed extends Error {
    constructor(message = "Failed to update entry") {
        super(message);
    }
}
exports.EntryUpdateFailed = EntryUpdateFailed;
